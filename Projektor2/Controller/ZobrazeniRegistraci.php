...
class Projektor2_Controller_ZobrazeniRegistraci extends Projektor2_Controller_Abstract {
    ...
    public function getResult() {
        ...
        if ($zajemciOsobniUdaje) {
            ...
            $viewZaznamy = new Projektor2_View_HTML_Element_Table(array('rows'=>$rows, 'class'=>'zaznamy'));
            $viewContent = new Projektor2_View_HTML_Element_Div(array('htmlParts'=>array($viewZaznamy), 'class'=>'content'));
            $parts[] = $viewContent;
        }   
