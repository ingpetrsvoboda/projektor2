 ...
 * @author pes2704
 */
class Projektor2_Controller_Ap_Certifikat_Kurz extends Projektor2_Controller_Ap_Certifikat_Abstract {
    ...
    public function getResult() {
        ...
        if (!$certifikat) {
            ...
            $viewPdf->assign('fullFileName', $certifikat->documentCertifikatKurz->documentPath);
