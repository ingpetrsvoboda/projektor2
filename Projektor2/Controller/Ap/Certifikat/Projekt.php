 ...
 * @author pes2704
 */
class Projektor2_Controller_Ap_Certifikat_Projekt extends Projektor2_Controller_Ap_Certifikat_Abstract {
    ...
    public function getResult() {
        ...
        $certifikat = $serviceCertifikat->create($this->sessionStatus->projekt, $this->sessionStatus->kancelar, 
                $this->sessionStatus->zajemce, $datumCertifikatu, $this->sessionStatus->user->username);
        if (!$certifikat) {
        ...
        $viewPdf->assign('fullFileName', $certifikat->documentCertifikatProjekt->documentPath);
