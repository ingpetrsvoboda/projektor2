...
class Projektor2_Controller_Formular_Ap_Dotaznik extends Projektor2_Controller_Formular_Base {
    ...
    protected function getResultFormular() {
        $vzdelaniModels = Projektor2_Model_Db_Ciselnik_VzdelaniMapper::findAll('', 'razeni');
        $context = array_merge($this->createContextFromModels(), array('vzdelaniModels'=>$vzdelaniModels));
        $view = new Projektor2_View_HTML_Ap_Dotaznik($context);
        return $view;
    }
