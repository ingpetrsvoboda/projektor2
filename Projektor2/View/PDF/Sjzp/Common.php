 ...
 * @author pes2704
 */
abstract class Projektor2_View_PDF_Sjzp_Common extends Projektor2_View_PDF_Common { 
    
    const STALY_TEXT_PATICKY =  "\n Projekt S jazyky za prací v Karlovarském kraji CZ.1.04/2.1.01/D8.00020 je financován z ESF prostřednictvím OP LZZ a ze státního rozpočtu ČR.";
    
     protected function setHeaderFooter($textPaticky=NULL) {
        parent::completeHeader("./img/loga/loga_OPLZZ_BW.jpg", 125,18);
