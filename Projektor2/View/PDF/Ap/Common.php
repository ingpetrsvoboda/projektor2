 ...
 * @author pes2704
 */
abstract class Projektor2_View_PDF_Ap_Common extends Projektor2_View_PDF_Common {  
...
//    const STALY_TEXT_PATICKY = "\nProjekt Alternativní práce v Plzeňském kraji CZ.1.04/2.1.00/70.00055 je financován z Evropského sociálního fondu prostřednictvím OP LZZ a ze státního rozpočtu ČR.";
    ...
    protected function setHeaderFooter($textPaticky=NULL, $cislovani=TRUE) {
        parent::completeHeader( "./img/loga/loga_AP_BW.png", 165,14 );
        parent::completeFooter( $textPaticky . self::STALY_TEXT_PATICKY, $cislovani);
    }
