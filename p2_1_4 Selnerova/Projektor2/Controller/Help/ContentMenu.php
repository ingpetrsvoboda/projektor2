 ...
 * @author pes2704
 */
class Projektor2_Controller_Help_ContentMenu implements Projektor2_Controller_ControllerInterface {
    ...
    public function __construct(Projektor2_Model_SessionStatus $sessionStatus, Projektor2_Request $request, Projektor2_Response $response) {
     ...
     public function getResult() {         
        ...
        $tlacitkaController = new Projektor2_Controller_Help_TlacitkaMenu($this->sessionStatus, $this->request, $this->response, $params);
