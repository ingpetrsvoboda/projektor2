 ...
 * @author pes2704
 */
class Projektor2_Controller_Sjzp_ContentMenu implements Projektor2_Controller_ControllerInterface {
...
//        $htmlResult .= "<h1>Menu zájemce</h1>";
        ...
        $tlacitkaController = new Projektor2_Controller_Sjzp_TlacitkaMenu($this->sessionStatus, $this->request, $this->response, $params);
