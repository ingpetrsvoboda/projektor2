 ...
 * @author pes2704
 */
abstract class Projektor2_Controller_Formular_Sjzp_Menus extends Projektor2_Controller_Formular_Base {
    protected function getLeftMenu() {
        $leftMenuController = new Projektor2_Controller_Sjzp_LeftMenu($this->sessionStatus, $this->request, $this->response);
