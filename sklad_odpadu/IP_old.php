 ...
 * @author pes2704
 */
abstract class Projektor2_Controller_Formular_Ap_IP extends Projektor2_Controller_Formular_Base {
    protected function getLeftMenu() {
        $leftMenuController = new Projektor2_Controller_Ap_LeftMenu($this->sessionStatus, $this->request, $this->response);
...
//     */
//    protected function assignKurzyToPdfView(Projektor2_Model_Flat_ZaPlanFlatTable $planFlatTable, Framework_View_Abstract $view) {
...
//        $view->assign('sebas_kurz', Projektor2_Model_SKurzMapper::findById($planFlatTable->id_s_kurz_sebas_FK));
//        $view->assign('forpr_kurz', Projektor2_Model_SKurzMapper::findById($planFlatTable->id_s_kurz_forpr_FK));
